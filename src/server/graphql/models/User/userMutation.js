...
export default {
  createUser: {
    ...
    async resolve(source, {email, password}) {
      ...
      if (user) {
        ...
        console.log('Verify url:', `http://r3stack.dev.azk.io/verify-email/${verifiedEmailToken}`);
  ...
  emailPasswordReset: {
    ...
    async resolve(source, {email}) {
      ...
      console.log('Reset url:', `http://r3stack.dev.azk.io/login/reset-password/${resetToken}`);
      return true;
    }
  },
  resetPassword: {
  ...
  resendVerificationEmail: {
    ...
    async resolve(source, args, {rootValue}) {
      ...
      console.log('Verified url:', `http://r3stack.dev.azk.io/login/verify-email/${verifiedEmailToken}`);
      return true;
    }
  },
  verifyEmail: {
