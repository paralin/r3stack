...
/* code can be: vendor-common, vendor-page-specific, r3stack-common, r3stack-page-specific
 * a small, fast landing page means only include the common from vendor + r3stack
 * long-term caching means breaking apart r3stack code from vendor code
...
const prefetches = [
  ...
  'joi/lib/index.js',
  'universal/containers/_Kanban/Kanban/KanbanContainer.js'
];
